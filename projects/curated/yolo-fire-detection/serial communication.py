                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img or uart_yes:  # Add bbox to image
                        ...
                        for i in range(0,len(xyxy)):
                            xy2xy[i] = int(xyxy[i])
                            xy4xy = int((xy2xy[0]+xy2xy[2])/2) ,int((xy2xy[1]+xy2xy[3])/2)
                            xy8xy = list(xy4xy)
                        counter=counter+1; 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/best_nano_v5.pt', help='model.pt path(s)')
