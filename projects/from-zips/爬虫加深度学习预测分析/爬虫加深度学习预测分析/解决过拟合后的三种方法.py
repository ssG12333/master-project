...
# 数据路径
data_folder = 'data'
output_base = '解决过拟合后的结果'
os.makedirs(output_base, exist_ok=True)

# 模型列表
models = {
    "线性回归": LinearRegression(),
    "决策树": DecisionTreeRegressor(random_state=42, max_depth=10, min_samples_split=5, min_samples_leaf=5),  # 限制深度和样本数
...
print("✅ 模型构建与评估完成，选股预测已保存到 stock_selection_model 文件夹中。")
